...
class PenggunaController extends BaseController{
	...
	function add($formdata = null){
		if($formdata){
			...
			$request = $this->request;
			//fillable fields
			$fields = $this->fields = array("username","nama","jenis_kelamin","alamat","jabatan","email","no_hp","foto");
	...
	function edit($rec_id = null, $formdata = null){
		...
		$tablename = $this->tablename;
		 //editable fields
		$fields = $this->fields = array("id_pengguna","username","nama","jenis_kelamin","alamat","jabatan","email","no_hp","foto");
		if($formdata){
			$postdata = $this->format_request_data($formdata);
			$this->rules_array = array(
				'username' => 'required',
     ...
     * @return BaseView
     */
	function password($fieldname = null , $fieldvalue = null){
		$request = $this->request;
		$db = $this->GetModel();
		$tablename = $this->tablename;
		$fields = array("id_pengguna", 
		...
		$this->view->report_paper_size = "A4";
		$this->view->report_orientation = "portrait";
		$this->render_view("pengguna/password.php", $data); //render the full page
	}
}
