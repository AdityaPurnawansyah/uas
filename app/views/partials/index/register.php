                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="input-group">
                                                    <input id="ctrl-nama"  value="<?php  echo $this->set_field_value('nama',""); ?>" type="password" placeholder="Enter Nama"  required="" name="nama"  class="form-control  password password-strength" />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="input-group">
                                                        <input id="ctrl-nama-confirm" data-match="#ctrl-nama"  class="form-control password-confirm " type="password" name="confirm_password" required placeholder="Confirm Password" />
                                                        <div class="input-group-append cursor-pointer btn-toggle-password">
                                                            <span class="input-group-text"><i class="fa fa-eye"></i></span>
                                                        </div>
